    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
          ...
          <AnimatePresence mode="popLayout">
            {filteredPosts.map((post) => (
              <motion.a 
                ...
                className={`relative aspect-square rounded-2xl group cursor-pointer overflow-hidden bg-gray-200 block ${post.size}`}
              >
                <img 
                  src={post.image} 
                  alt={post.platform}
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-6 text-white">
                  ...
                  <div className="flex justify-between items-start translate-y-[-20px] group-hover:translate-y-0 transition-transform duration-500 gap-6">
                    ...
                    <button 
                      ...
                      className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center text-zinc-900 hover:bg-blue-600 hover:text-white transition-colors"
                    >
                      <Share2 size={16} />
                    </button>
                  </div>
        ...
        <div className="mt-20 text-center">
          <a 
            href="https://www.instagram.com/zway_fashion"
            target="_blank"
            rel="noopener noreferrer"
            className="group relative inline-block px-12 py-5 bg-zinc-900 text-white rounded-full overflow-hidden transition-all hover:pr-16"
          >
